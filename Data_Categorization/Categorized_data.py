...
def display_categorized_data(df, country_options, country_mapping):
    ...
    st.markdown("<h3 style='color: #1b9e4b;'>This section provides an overview of the categorization process.</h3>",
                unsafe_allow_html=True)

    st.markdown("""
    The categorization process outlined below is structured into <span style='color: #1b9e4b;'>8 distinct levels</span> of analysis. At the <span style='color: #1b9e4b;'>first</span> level, all received feedback is grouped together, forming the primary dataset. Moving to the <span style='color: #1b9e4b;'>second</span> level, this feedback is segmented by country. At the <span style='color: #1b9e4b;'>third</span> level, within each country, the feedback is sorted into three categories: positive, neutral, and negative. The <span style='color: #1b9e4b;'>fourth</span> level focuses on negative feedback, which is prioritized in the context of "Patient Care." This feedback is further broken down by medical practice areas, specifically highlighting three key areas in this example: Clinical Medicine, Surgery, and Mental Health.

    At the <span style='color: #1b9e4b;'>fifth</span> level, I delve deeper within each practice area to include medical specialties, such as Cardiology and Endocrinology within the Clinical Medicine group. This approach by specialty aims to identify behavioral patterns within professional groups, enabling the development of broad-scale solutions.

    Moving to the <span style='color: #1b9e4b;'>sixth</span> level, I focus on the process touchpoints, particularly within the Mental Health area in this example, highlighting the 11 touchpoints in the patient journey and identifying specific opportunities for operational improvement at DocPlanner. The <span style='color: #1b9e4b;'>seventh</span> level assesses interactions based on three levels of urgency: low, medium, and high. Finally, at the <span style='color: #1b9e4b;'>eighth</span> level, within the high-urgency category, I consider the limited capacity for action but with strong influence; through this "mass strategy," it is possible to enhance positive persuasion and drive improvements in medical best practices using real data from DocPlanner, thus completing the analysis framework and providing a strategic overview of the operation.
...
│   │       │   │           └── 1.1.1.3.1.3.2.1.10 Leave Review and Feedback
    ...
    st.markdown("In the next section, <span style='color: #1b9e4b;'><strong>Critical Points Analysis</strong></span>, accessible from the sidebar on your left (⬅️), you'll gain deeper insights into how the touchpoints of the process were developed and mapped, providing a comprehensive understanding of their role within the overall framework.", unsafe_allow_html=True)
